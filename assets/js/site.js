...
(function (global) {
  ...
  var CHAPTERS = [
    ...
    { n: '04', title: '그라운딩 — 좌표를 말하게 하기', status: 'draft',
      sub: '박스를 텍스트로 뱉는 모델들, 그리고 좌표 표기법.' },
    { n: '05', title: '제로샷 검출의 하한선', status: 'draft',
      sub: '학습 없이 어디까지 되는가, 그리고 어디서 무너지는가.' },
    { n: '06', title: 'LoRA — 큰 모델을 얇게 고치기', status: 'draft',
      sub: '저랭크 어댑터의 수학과, 무엇을 얼리고 무엇을 열 것인가.' },
    { n: '07', title: '데이터 만들기 — instruction', status: 'draft',
      sub: '멀티모달 instruction 데이터의 합성과 검증.' },
    { n: '08', title: '판정기로 쓰는 VLM', status: 'draft',
      sub: '생성 모델을 분류기처럼 쓰는 법과 그 함정.' },
    { n: '09', title: '제약 채점과 확률 읽기', status: 'draft',
      sub: '로짓을 직접 읽어 후보를 제한하는 채점 방식.' },
    { n: '10', title: '멀티모달 판정기 전환', status: 'draft',
